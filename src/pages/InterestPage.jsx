    ...
    <div className="flex flex-col min-h-screen font-opensans bg-base-200">
      ...
      <div className="my-5 mx-10 lg:mx-80 md:mx-36">
        ...
        <div className="chat chat-end mb-5">
          ...
          <div className="chat-bubble chat-bubble-warning">
            Web Developer - As an aspiring web developer, I am constantly honing
            my skills by creating innovative and user-friendly websites.
          </div>
        </div>
        <div className="chat chat-end mb-5">
          <div className="chat-image avatar">
        ...
        <div className="chat chat-end mb-5">
          ...
          <div className="chat-bubble chat-bubble-warning">
            ...
            of fantasy, and the thrill of action, finding solace and inspiration
            in every page.
          </div>
        </div>
        <div className="chat chat-end mb-5">
          ...
          <div className="chat-bubble chat-bubble-warning">
            ...
            playlists on YouTube that accompany me from the moment I rise to the
            time I drift off to sleep, transforming my day into a melodic
            journey.
          </div>
        </div>
        <div className="chat chat-end mb-5">
          ...
          <div className="chat-header">Putri Nabella</div>
          <div className="chat-bubble chat-bubble-warning">
            Watching Movies - I indulge in the cinematic experience, where each
            film becomes a portal to new adventures and emotions, allowing me to
            escape reality and explore diverse narratives from the comfort of my
            couch.
          </div>
        </div>
      </div>
